...
# for new config
##############################################################################
'''config = ["new_config_single","new_config_multi"]
commu_type =["single_layer","multi_layer"]

str0 = "./new_config_mod/mQ_modified_new_march21/"
