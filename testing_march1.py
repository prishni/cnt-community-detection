	...
	for c in commu:
		...
		if len(intra_inter[c])>1:
			for l in layer:
				...
				print c,l,mod,mu,mu*mod,I_layer,m_layer,d_layer,(I_layer/m_layer),((d_layer/(2*m_layer))*(d_layer/(2*m_layer)))
				if f==1:
					modc_layer+=mu*mod
				else:	
					modc_layer+=mod
	...
	for coupling_type in coupling_types:
		...
		for fr in range(10,101,10):
			...
			for perturb in range(0,101):
				...
				str13='./new_config_single/with_0_coupling/Test_config(20%)/test_config'+str(frac)+'.txt'
				print str13
