...
for fr in p:
	...
	for perturb in range(0,101):
		...
		str1='./single_layer_complete_clique/Test_config('+str(fr)+'%)/test_config'+str(frac)+'.txt'
		if not os.path.exists('./single_layer_complete_clique/Test_config('+str(fr)+'%)'):
			    os.makedirs('./single_layer_complete_clique/Test_config('+str(fr)+'%)')
		fp=open(str1,'w')
